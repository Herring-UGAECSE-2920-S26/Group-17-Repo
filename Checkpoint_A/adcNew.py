...
class Voltmeter:
    ...
    def __init__(self, pi):
        # --- Configuration ---
        self.GPIO_VIN_CTRL = 17  # Controls Vin MOSFET 
        self.GPIO_VREF_CTRL = 13 # Controls Vref MOSFET
        self.GPIO_COMP_IN = 4   # Comparator Output
        self.GPIO_CAP_RS = 15   # Capacitor reset switch
    ...
    def get_resistance(self):
        ...
        if t1 is not None:
            ...
            rin = -4406 + -0.0406*t2 + 1.35E-5 *t2*t2
